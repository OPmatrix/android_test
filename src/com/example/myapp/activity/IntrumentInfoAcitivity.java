...
public class IntrumentInfoAcitivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView availableProcessors = (TextView) findViewById(R.id.availableProcessors);
        availableProcessors.setText(String.valueOf(Runtime.getRuntime().availableProcessors()));
